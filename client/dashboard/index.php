                    ...
                    <div data-spy="scroll" class="scroll scrollspy-example z-depth-1">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <div class="table-responsive">
                                <table id="dataTable"
                                    class="table table-hover table-striped table-bordered table-sm table-fixed-sm"
                                    cellspacing="0" width="100%">
                                    <thead class="text-center">
                                        <tr>

                                            <th scope="col" class="th-sm-6">Image
                                            </th>

                                            <th scope="col" class="th-sm-6">Name
                                            </th>
                                            <th scope="col" class="th-sm-6">Price
                                            </th>
                                            <th scope="col" class="th-sm-6">Amount
                                            </th>
                                            <th scope="col" class="th-sm-6">Action
                                            </th>
